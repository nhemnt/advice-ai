...
export default function Form({ generate, result, loading }: Props) {
    ...
    <form onSubmit={onSubmit}>
      <div className="space-y-6">
        <input
          name="prompt"
          type="text"
          placeholder="how to reply my manager when they are asking me to finish the work after my working hours?"
